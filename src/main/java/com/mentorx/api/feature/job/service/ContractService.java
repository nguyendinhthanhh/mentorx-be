...
public interface ContractService {
    ...
    ContractResponse getCurrentMentorContract(UUID contractId);
    ...
    Page<ContractResponse> getCurrentMentorContracts(Pageable pageable);
    ...
    ContractResponse requestCancellation(UUID contractId, ContractCancellationRequest request);
    ContractResponse approveCancellation(UUID contractId, ContractCancellationDecisionRequest request);
    ContractResponse rejectCancellation(UUID contractId, ContractCancellationDecisionRequest request);
}
